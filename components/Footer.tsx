        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/loan-compare" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Compare Loans
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © 2024 UniMoney. All rights reserved.
            </div>
            <div className="text-gray-400 text-sm">
              <p className="mb-2">
                <strong>Disclaimer:</strong> UniMoney is a loan comparison platform and not a licensed financial service provider.
              </p>
              <p>
                We are currently exploring regulatory requirements and working towards compliance.
              </p>
            </div>
          </div>
        </div>
